  ...
  ngOnInit() {
    ...
    this.chartOptions = {
      ...
      series: this.series.length ? this.series : [
        { name: 'Page Views', data: [0, 86, 28, 115, 48, 210, 136] },
        { name: 'Sessions', data: [0, 43, 14, 56, 24, 105, 68] }
      ],
      stroke: {
        curve: 'smooth',
        width: 2
      ...
      xaxis: {
        categories: this.categories.length ? this.categories : ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
        labels: {
          style: {
            colors: [
              '#8c8c8c',
